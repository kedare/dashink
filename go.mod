...
require (
	...
	periph.io/x/host/v3 v3.8.5-0.20250402005352-9cd28b79cdd1
)

replace periph.io/x/devices/v3 v3.7.4 => github.com/gsexton/devices/v3 v3.6.12-0.20250404212155-e27ed10928ea
